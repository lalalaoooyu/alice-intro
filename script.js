...
const translations = {
  en: {
    ...
    "hero.title": "Make the<br>complex simple.",
    "hero.desc": "Vibe Coder / AI Automation / Investor. Tokyo.",
    "about.title": "About",
    ...
    "skills.s1": "AI-driven efficiency",
    "skills.s2": "Design sensibility",
    "skills.s3": "English / Japanese / Chinese",
    ...
    "projects.p3.title": "Budget Book",
    "projects.p3.desc": "A lightweight personal budget tracking web app built with React + TypeScript + Chart.js.",
    "projects.p4.title": "Alice's Learning Library",
    "projects.p4.desc": "A curated collection of resources on AI, investing, and personal growth.",
    "projects.p5.title": "Market Mind",
    "projects.p5.desc": "An interactive web app that diagnoses your investor personality through 10 real market scenarios. React + Recharts.",
    "projects.p6.title": "Master Investors Q&A",
    "projects.p6.desc": "AI-powered Q&A with 4 legendary investors. Get diverse perspectives on your investment questions. React + Claude API.",
  ...
  zh: {
    ...
    "projects.p3.title": "Budget Book / 家计簿",
    "projects.p3.desc": "轻量级个人记账 Web 应用，使用 React + TypeScript + Chart.js 构建。",
    "projects.p4.title": "Alice's Learning Library",
    "projects.p4.desc": "关于 AI、投资和个人成长的精选资源合集。",
    "projects.p5.title": "Market Mind",
    "projects.p5.desc": "通过 10 个真实行情场景诊断你的投资人格的互动 Web 应用。React + Recharts。",
    "projects.p6.title": "投资大师问答",
    "projects.p6.desc": "AI 驱动的 4 位传奇投资大师问答。多元视角助力投资决策。React + Claude API。",
    "experience.title": "经历",
  ...
  ja: {
    ...
    "about.p2": "フレンドリー、シンプル、効率を大切にしています。<br>プライベートではAIと投資を研究中。日本語、英語、中国語が話せます。興味があればぜひコーヒーチャットしましょう。",
    "skills.title": "スキル",
    "skills.dev": "開発",
    "skills.cloud": "クラウド & DevOps",
    "skills.strengths": "強み",
    "skills.s1": "AIによる業務効率化",
    "skills.s2": "美的センス",
    "skills.s3": "日本語・中国語・英語",
    "projects.title": "プロジェクト",
    "projects.work": "業務",
    "projects.personal": "個人",
    ...
    "projects.p3.title": "Budget Book / 家計簿",
    "projects.p3.desc": "軽量な個人向け家計簿Webアプリ。React + TypeScript + Chart.jsで構築。",
    "projects.p4.title": "Alice's Learning Library",
    "projects.p4.desc": "AI・投資・自己成長に関する厳選リソース集。",
    "projects.p5.title": "Market Mind",
    "projects.p5.desc": "10の相場シナリオで投資家タイプを診断するWebアプリ。React + Recharts。",
    "projects.p6.title": "Master Investors Q&A",
    "projects.p6.desc": "4人の投資巨匠がAIで質問に回答。多角的な視点で投資判断をサポート。React + Claude API。",
    "experience.title": "経歴",
